...
import com.migreat.network.network.GifDetailResponse
import com.migreat.network.network.TrendingResponse
...
class GiphyService {
    ...
    private val service: GiphyApi = retrofit.create<GiphyApi>(
        GiphyApi::class.java)
